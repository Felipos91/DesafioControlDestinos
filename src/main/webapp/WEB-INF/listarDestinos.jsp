											...
											<tbody>
												<c:forEach var="destinoPasajeros" items="${listadoPasajerosDestinos}">
													...
													<tr>
														...
														<td><c:out value="${destinoPasajeros.destino.pais}"></c:out></td>
														<td><c:out value="${destinoPasajeros.destino.fecha}"></c:out></td>
														<td><c:out value="${destinoPasajeros.pasajero.nombre} ${destinoPasajeros.pasajero.apellido}"></c:out></td>
